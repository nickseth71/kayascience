class FacetFiltersForm extends HTMLElement {
  ...
  static renderPage(searchParams, event, updateURLHash = true) {
    console.log(event,'---event--',searchParams);
    if(event){
      console.log(event.target.name,"---event.target.name");
      var target_name = event.target.name; 
      var filter_value = event.target.defaultValue;
      var checked_val = event.target.checked;
      var filter_type = target_name.split('.').pop();
      if(checked_val == true){
        console.log(target_name,"--target_name---","--filter_value--",filter_value,"---filter_type--",filter_type); 
        webengage.track('filter applied', {
